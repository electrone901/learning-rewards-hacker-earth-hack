...
//   } = useWeb3React()
//   console.log(
//     '🚀 ~ file: CoinbaseWallet.js:31 ~ CoinbaseWallet ~ active',
//     active,
//   )
...
//     console.log(
//       '🚀 ~ file: CoinbaseWallet.js:114 ~ useEffect ~ provider',
//       provider,
//     )
//     if (provider) activate(connectors[provider])
//   }, [])

//   const coinbaseWalletBtn1 = async () => {
//     console.log('setProvider coinbaseWallet')
...
//         Make sure you are using Klaynt or Mumbai network ⬆️
//       </Text>
...
//         <Button variant="outline" onClick={coinbaseWalletBtn1} w="100%">
//           YAY
//         </Button>
...
//                   <option value="1001">Baobab</option>
