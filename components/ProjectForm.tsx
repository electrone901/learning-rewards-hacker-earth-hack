...
export default function PageWithJSbasedForm() {
  ...
  const handleSubmit = async (event: FormEvent) => {
    ...
    alert(`Is this your full name: ${result.instagram}`)
  }
  return (
    <div className="container">
      <Navbar account={undefined} setAccount={undefined} />
      ...
      <form className={styles.description} onSubmit={handleSubmit}>
        ...
        <input className={styles.description} type="text" size="50" height="100%" id="description" name="description" required />
        ...
        <button className={styles.savePost} type="submit">Submit</button>
      </form>
    </div>
  )
}
